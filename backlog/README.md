...
- `backlog-registry-v1.0.0.md` — The canonical registry. All deferred projects are logged here with last-known state, priority, and blocking dependencies.
...
- Adding a new backlog item requires a row in `backlog-registry-v1.0.0.md` with:
  - Unique ID (`BL-XXX`)
  - Project name
  - Domain
  - Last state
